...
<!--to_give -->
<div class="modal fade" id="to_give" role="dialog">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="form-group input-group">
                    <span class="input-group-addon">Studant Name</span>
                    <input type="text" autofocus name="name" class="form-control" required/>
                </div>
                <div class="form-group input-group">
                    <span class="input-group-addon">Chemical Name</span>
                    <select name="chemical" class="form-control">
                        <?php while($cami = mysqli_fetch_array($getcamicalname)): ?>
                            <?php $select = ($cami['name']==$row['chemical']) ? "selected=selected" : null; ?>
                            <option <?php echo $select; ?>><?php echo $cami['name'];?></option>
                        <?php endwhile; ?>
                    </select>
                </div>
                <div class="form-group input-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group input-group">
                    ...
                    <input type="text" autofocus name="company" class="form-control" required/>
                </div>
                <div class="form-group">
                    <label>Description:</label>
                    <textarea class="ckeditor" name="description"></textarea>
                ...
                <div class="form-group input-group">
                    ...
                    <select name="supplier" class="form-control">
                        <?php while($rows = mysqli_fetch_array($getsupplier2)): ?>
